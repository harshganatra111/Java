...
public class MyFirst3D_WithLight implements WindowListener, GLEventListener, KeyListener {
	...
	public MyFirst3D_WithLight() // Konstruktor
	{
		createFrame();
	}
